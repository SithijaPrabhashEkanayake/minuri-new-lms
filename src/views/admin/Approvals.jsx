        ...
        <div className="grid g3">
          {approvals.map(a => (
            <div key={a.id} className="glass card-pad fade-up" style={{ padding: '22px' }}>
              ...
              {a.receiptUrl && (
                <a href={`${a.receiptUrl}`} target="_blank" rel="noreferrer" style={{ display: 'block', marginBottom: '16px' }}>
                  <img src={`${a.receiptUrl}`} alt="Receipt" style={{ width: '100%', height: '120px', objectFit: 'cover', borderRadius: '8px', border: '1px solid #eee' }} />
                </a>
              )}
